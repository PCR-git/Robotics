...
% Solver
function [Tx,Yx,Tex,Yex,PHI_Tx,qppx] = Solver(t_f,Te,Yi,M,LVec,n,m,s,g,time2steps,Control,Fr,PF,rwi,rwj,Ck,Disturb,Noise,WPtol,Go,WPang,WPNum,CatchDistance)
