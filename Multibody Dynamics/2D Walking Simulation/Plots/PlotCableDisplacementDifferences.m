% Computes and Plots Cable Displacement Differences

function PlotCableDisplacementDifferences(T,Y,n,m,s,MechData)
...
% ------------
% Plot of Cable Displacement Differences vs Time

figure;
plot(Tu, 100*(abs(CD1LVecA-CD1LVecA(1,1))-abs(CD1RVecA-CD1LVecA(1,1)))/CD1LVecA(1,1));
hold on;
plot(Tu, 100*(abs(CD2LVecA-CD2LVecA(1,1))-abs(CD2RVecA-CD2LVecA(1,1)))/CD2LVecA(1,1));
plot(Tu, 100*(abs(CD3LVecA-CD3LVecA(1,1))-abs(CD3RVecA-CD3LVecA(1,1)))/CD3LVecA(1,1));
% Plot specs
xlabel('Time (s)','FontSize',20,'FontName','Times New Roman');
ylabel('Percent Error','FontSize',20,'FontName','Times New Roman');
title('Cable Displacement Error','FontSize',20,'FontName','Times New Roman');
